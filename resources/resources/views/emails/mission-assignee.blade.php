...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 10px 25px; background: #6c63ff; color: white; text-decoration: none; border-radius: 5px; margin-top: 15px; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="content">
        ...
        <p>Connectez-vous à l'application pour voir les détails et gérer cette mission.</p>
    </div>
    <div class="footer">
        <p>© {{ date('Y') }} SAV Mikem - Gestion des missions d'intervention</p>
    </div>
</body>
</html>
