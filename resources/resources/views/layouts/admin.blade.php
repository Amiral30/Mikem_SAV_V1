...
<head>
    ...
    <meta name="description" content="Panneau d'administration SAV Mikem - Gestion des missions d'intervention">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="{{ route('admin.missions.create') }}" class="nav-link {{ request()->routeIs('admin.missions.create') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.techniciens.create') }}" class="nav-link {{ request()->routeIs('admin.techniciens.create') ? 'active' : '' }}">
