...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-value">{{ $stats['total_assignees'] }}</div>
...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ route('technicien.missions.index') }}" class="btn btn-secondary btn-sm">Voir tout</a>
    </div>
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="7" class="text-center text-muted" style="padding:40px;">Aucune mission active pour le moment.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
