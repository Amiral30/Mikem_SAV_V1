...
@section('page-subtitle', 'Toutes vos missions assignées')

@section('content')
<div class="filter-bar">
    <form action="{{ route('technicien.missions.index') }}" method="GET" style="display:flex; gap:12px; flex-wrap:wrap;">
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="{{ route('technicien.missions.show', $mission) }}" style="color:var(--text-primary); font-weight:600;">{{ $mission->titre }}</a></td>
                    ...
                    <td><a href="{{ route('technicien.missions.show', $mission) }}" class="btn btn-primary btn-sm">Détails</a></td>
                </tr>
                @empty
                <tr><td colspan="6" class="text-center text-muted" style="padding:40px;">Aucune mission trouvée.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
