...
@section('topbar-actions')<a href="{{ route('admin.techniciens.edit', $technicien) }}" class="btn btn-secondary btn-sm">✏️ Modifier</a>@endsection

@section('content')
<div class="mission-detail-grid">
    <div>
        <div class="card mb-3">
            <div class="card-header"><h3>👤 Informations</h3><span class="badge {{ $technicien->disponible?'badge-disponible':'badge-occupe' }}">{{ $technicien->disponible?'Disponible':'Occupé' }}</span></div>
            <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table">
                    <thead><tr><th>Mission</th><th>Type</th><th>Date</th><th>Statut</th></tr></thead>
                    <tbody>
                        ...
                        @empty<tr><td colspan="4" class="text-center text-muted" style="padding:30px;">Aucune mission</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
