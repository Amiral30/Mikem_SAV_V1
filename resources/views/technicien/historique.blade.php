        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>@if($rapport)<span class="badge badge-success">Soumis</span>@else<a href="{{ route('technicien.rapports.create', $mission) }}" class="badge badge-warning" style="text-decoration:none;">À rédiger</a>@endif</td>
                    <td><div class="btn-group"><a href="{{ route('technicien.missions.show', $mission) }}" class="btn btn-secondary btn-sm">👁️</a>@if($rapport)<a href="{{ route('technicien.rapports.show', ['mission'=>$mission,'rapport'=>$rapport]) }}" class="btn btn-secondary btn-sm">📝</a>@endif</div></td>
                </tr>
